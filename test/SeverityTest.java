...
public class SeverityTest {
    ...
    void testSeverityIncreasesWithDetectorCount() {
        ...
        List<DetectionAlert> alerts1 = List.of(
                new DetectionAlert("10.0.0.1", "SQL injection", "SQL Injection")
        );
        ...
        List<DetectionAlert> alerts2 = List.of(
                new DetectionAlert("10.0.0.2", "SQL injection", "SQL Injection"),
                new DetectionAlert("10.0.0.2", "Brute force", "Brute Force")
        );
        ...
        List<DetectionAlert> alerts3 = List.of(
                new DetectionAlert("10.0.0.3", "SQL injection", "SQL Injection"),
                new DetectionAlert("10.0.0.3", "Brute force", "Brute Force"),
                new DetectionAlert("10.0.0.3", "Scan", "Scan")
        );
